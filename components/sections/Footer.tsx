        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          >
            ...
            <p className="text-emerald-100 leading-relaxed">
              Premium liquid products you can trust. Manufactured with care,
        ...
        >
          <p className="text-emerald-100 flex items-center justify-center gap-2 flex-wrap">
            ...
            <span className="hidden sm:inline">
              by <a className='text-green-400' target='blank' href="https://pappycoder.vercel.app">PappyCoder</a>
            </span>
          </p>
        </motion.div>
      </div>
